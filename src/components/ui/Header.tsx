...
export default function Header() {
  ...
  return (
    <header className="relative z-20 w-full h-auto flex justify-center items-center">
      ...
      {/* Tablet */}
      <section className="hidden md:flex lg:hidden justify-between items-center w-9/10 h-auto py-8 border-b-2 border-b-white/20">
      ...
      {/* Mobile */}
      <section className="flex md:hidden justify-between items-center w-9/10 h-auto py-8 border-b-2 border-b-white/20">
        <Button onClick={() => console.log("hello")} className="p-0!" variant="icon">
