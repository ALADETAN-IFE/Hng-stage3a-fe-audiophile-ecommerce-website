...
export const products: Product[] = [
  {
    ...
    inTheBox: [
      { qty: '1x', item: 'Headphone Unit' },
      { qty: '2x', item: 'Replacement Earcups' },
      { qty: '1x', item: 'User Manual' },
      { qty: '1x', item: '3.5mm 5m Audio Cable' },
      { qty: '1x', item: 'Travel Bag' },
    ],
  },
  {
  ...
  },
  {
    ...
    inTheBox: [
      { qty: '2x', item: 'Speaker Unit' },
      { qty: '2x', item: 'Speaker Cloth Panel' },
      { qty: '1x', item: 'User Manual' },
      { qty: '1x', item: '3.5mm 10m Audio Cable' },
      { qty: '1x', item: '10m Optical Cable' },
    ],
  },
  {
    title: "ZX7 SPEAKER",
    ...
    inTheBox: [
      ...
      { qty: '2x', item: 'Speaker Cloth Panel' },
      { qty: '1x', item: 'User Manual' },
      { qty: '1x', item: '3.5mm 7.5m Audio Cable' },
      { qty: '1x', item: '7.5m Optical Cable' },
    ],
  },
  {
    ...
    inTheBox: [
      { qty: '2x', item: 'Earphone Unit' },
      { qty: '6x', item: 'Multi-size Earplugs' },
      { qty: '1x', item: 'User Manual' },
      { qty: '1x', item: 'USB-C Charging Cable' },
      { qty: '1x', item: 'Travel Pouch' },
    ],
  },
];
...
export function getProductByTitle(id: string) {
  const normalizedId = normalizeForCompare(id);
  console.log('normalizedId =', normalizedId);
  return products.find((p) => normalizeForCompare(p.title) === normalizedId);
}
